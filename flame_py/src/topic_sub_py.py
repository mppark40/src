...
def main():
	...
	rospy.Subscriber('flame_detect', flame_msg, callback_flame)
	rospy.Subscriber('both_gas_flame_detect', flame_msg, callback_both)
	rospy.Subscriber('gas_detect', flame_msg, callback_gas)
